...
const cliAdapterConfig = {
  ...
  schemaVersion: 1,
  executable: "codex",
  argumentTemplate: ["-a", "{{approval}}", "-c", "model_reasoning_effort=\"{{reasoning_effort}}\"", "exec", "--json", "--sandbox", "{{sandbox}}", "--model", "{{model}}", "--output-schema", "{{output_schema}}", "{{prompt}}"],
  ...
  cliAdapter: {
    ...
    presets: [
      ...
      },
      {
        ...
        environmentAllowlist: ["ANTHROPIC_API_KEY", "ANTHROPIC_AUTH_TOKEN", "ANTHROPIC_BASE_URL", "ANTHROPIC_MODEL", "CLAUDE_CODE_OAUTH_TOKEN"],
