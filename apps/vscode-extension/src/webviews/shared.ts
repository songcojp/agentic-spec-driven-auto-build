...
export function renderWorkbenchInputForm(): string {
  return `<section id="workbench-form" class="panel workbench-form" hidden data-form-mode="newFeature">
    ...
    <div class="workbench-chat">
      <div class="workbench-dialog system"><span class="workbench-dialog-label">SpecDrive</span><p id="workbench-form-prompt">Enter add-or-change content.</p></div>
      <label class="workbench-dialog user"><span class="workbench-dialog-label">You</span><textarea id="workbench-form-input" aria-label="Feature input"></textarea></label>
    </div>
