...
export function renderWorkbenchPage(title: string, nonce: string, body: string, cspSource?: string, locale: WorkbenchLocale = "en"): string {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src ${imgSource}; style-src 'unsafe-inline'; script-src 'nonce-${nonce}';"><style>
    ...
    html[data-workbench-theme="light"]{color-scheme:light;--accent:#0875d1;--accent-strong:#075aa0;--accent-soft:rgba(8,117,209,.11);--ok:#218a43;--warn:#9a6700;--bad:#c9362c;--info:#0969da;--muted:#5f6b7a;--bg:#f6f8fb;--bg-elevated:#ffffff;--panel:#ffffff;--panel-strong:#edf2f7;--border:#d8dee8;--border-soft:#e8edf3;--shadow:0 8px 24px rgba(24,33,47,.08)}
    html[data-workbench-theme="dark"]{color-scheme:dark;--accent:#20d7d2;--accent-strong:#13b8c2;--accent-soft:rgba(24,189,198,.15);--ok:#5bd46f;--warn:#f4b63d;--bad:#f26a63;--info:#5aa9ff;--muted:#94a3ad;--bg:#0d1418;--bg-elevated:#102029;--panel:#11181d;--panel-strong:#0b1115;--border:#31414c;--border-soft:#22313a;--shadow:0 10px 28px rgba(0,0,0,.28)}
    html[data-workbench-theme="highContrast"]{color-scheme:dark;--accent:#ffff00;--accent-strong:#ffffff;--accent-soft:rgba(255,255,0,.18);--ok:#00ff66;--warn:#ffff00;--bad:#ff6666;--info:#66ccff;--muted:#ffffff;--bg:#000;--bg-elevated:#050505;--panel:#000;--panel-strong:#050505;--border:#ffffff;--border-soft:#808080;--shadow:none}
    *{box-sizing:border-box}body{margin:0;padding:14px 16px 18px;font-family:var(--vscode-font-family,"Segoe UI",system-ui,sans-serif);color:var(--vscode-foreground);background:radial-gradient(circle at 22% 0,rgba(20,184,166,.10),transparent 34%),linear-gradient(180deg,color-mix(in srgb,var(--bg) 88%,#12252b),var(--bg));line-height:1.45}
    ...
    .execution-layout{display:grid;grid-template-columns:minmax(280px,38%) minmax(0,1fr);gap:10px;align-items:start}.execution-queue-column,.current-selected-column{min-width:0}.current-selected-column{overflow:visible}
    ...
    const currentWorkbenchTheme = () => {
      ...
      return storedTheme || stateTheme || "vscode";
    };
    const applyTheme = (theme) => {
      ...
      vscode.postMessage({command:"setWorkbenchTheme", theme:selected});
    };
    ...
    applyTheme(currentWorkbenchTheme());
