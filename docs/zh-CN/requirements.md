...
THE SYSTEM SHALL 要求输出 `contractVersion = "skill-contract/v2"`，并在 `result.deliveryFidelity` 中提供完整账本；`skill-contract/v1` 仅可作为 legacy 或非 feature execution 输出读取。
...
| PRD 第 6.14 节 Delivery Lifecycle OS | REQ-087, REQ-088, REQ-089, REQ-090, REQ-091, REQ-092 | 全流程交付保真、行为义务、质量损失、专用 agent/skill 工作流、v2 输出契约和规格颗粒度门禁 |
...
| M9：Delivery Fidelity | REQ-087, REQ-088, REQ-089, REQ-090, REQ-091, REQ-092 |
