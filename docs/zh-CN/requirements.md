...
- [ ] Spec Protocol 初始化不得在目标项目创建 `docs/change-management.md`、`docs/zh-CN/change-management.md` 或 `docs/*/change-disposition-checklist.md`；需求新增/变更协议必须由 `.agents/skills/manage-spec-change/SKILL.md` 承载。
