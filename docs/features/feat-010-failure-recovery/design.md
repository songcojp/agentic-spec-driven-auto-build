...
| Recovery Task Builder | 生成恢复任务和 12.recovery.classify-failure 输入。 |
...
5. Recovery Task Builder 调用 12.recovery.classify-failure。
...
- FEAT-003 提供 12.recovery.classify-failure。
- FEAT-007 提供回滚边界。
