---
name: 08.test.generate-unit-tests
description: "Run the Agentic Spec test generate unit tests workflow. Use when the scheduler, operator, or another skill explicitly requests `08.test.generate-unit-tests` and needs traceable test plans, test cases, failure analysis, acceptance mappings, or verification results inside the test and verification boundary."
---
...
1. Confirm the invocation requested `08.test.generate-unit-tests`, identify the target artifact or object, and verify the current state allows this generate unit tests step.
...
6. If this invocation generates or updates test-spec documents, run the
