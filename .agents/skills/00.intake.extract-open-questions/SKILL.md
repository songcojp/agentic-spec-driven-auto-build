...
description: "Execute the Agentic Spec 00 intake workflow for extract open questions with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `00` `intake` workflow step for `extract-open-questions`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
