---
name: 02.requirements.normalize
description: "Run the Agentic Spec requirements normalize workflow. Use when the scheduler, operator, or another skill explicitly requests `02.requirements.normalize` and needs traceable testable requirements, readiness findings, conflicts, or traceability updates inside the requirements and traceability boundary."
---
...
1. Confirm the invocation requested `02.requirements.normalize`, identify the target artifact or object, and verify the current state allows this normalize step.
