...
description: "Execute the Agentic Spec 08 test workflow for map to acceptance with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `08` `test` workflow step for `map-to-acceptance`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
