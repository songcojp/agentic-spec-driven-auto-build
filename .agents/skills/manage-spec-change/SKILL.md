...
description: "Manage SpecDrive requirement and spec changes. Use when adding, changing, clarifying, deprecating, invalidating evidence for, or routing a requirement or feature-spec change."
---
...
Classify whether the request adds new behavior or changes existing IDs. Update the mainline spec lane first and produce schedulable Feature Spec impacts when required.
