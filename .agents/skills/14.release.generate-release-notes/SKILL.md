...
description: "Execute the Agentic Spec 14 release workflow for generate release notes with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `14` `release` workflow step for `generate-release-notes`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
