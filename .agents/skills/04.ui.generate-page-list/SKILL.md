...
description: "Execute the Agentic Spec 04 ui workflow for generate page list with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `04` `ui` workflow step for `generate-page-list`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
