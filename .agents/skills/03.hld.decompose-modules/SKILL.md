...
description: "Run the Agentic Spec HLD decompose modules workflow. Use when the scheduler, operator, or another skill explicitly requests `03.hld.decompose-modules` and needs traceable architecture decisions, state/data flows, adapter models, or HLD outputs inside the architecture and design-decision boundary."
---
...
1. Confirm the invocation requested `03.hld.decompose-modules`, identify the target artifact or object, and verify the current state allows this decompose modules step.
