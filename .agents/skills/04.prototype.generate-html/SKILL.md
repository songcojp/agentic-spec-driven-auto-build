...
description: "Execute the Agentic Spec 04 prototype workflow for generate html with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `04` `prototype` workflow step for `generate-html`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
