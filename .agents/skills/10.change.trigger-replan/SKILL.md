...
description: "Execute the Agentic Spec 10 change workflow for trigger replan with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `10` `change` workflow step for `trigger-replan`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
