...
description: "Execute the Agentic Spec 02 requirements workflow for update traceability with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `02` `requirements` workflow step for `update-traceability`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
