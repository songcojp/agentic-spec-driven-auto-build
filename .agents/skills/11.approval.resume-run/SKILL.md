---
name: 11.approval.resume-run
description: "Run the Agentic Spec approval resume run workflow. Use when the scheduler, operator, or another skill explicitly requests `11.approval.resume-run` and needs traceable approval gate packages, decisions, rejection/replan results, human-review requests, or resume decisions inside the approval-gate boundary."
---
...
1. Confirm the invocation requested `11.approval.resume-run`, identify the target artifact or object, and verify the current state allows this resume run step.
