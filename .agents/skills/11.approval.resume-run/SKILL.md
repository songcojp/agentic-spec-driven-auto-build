...
description: "Execute the Agentic Spec 11 approval workflow for resume run with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `11` `approval` workflow step for `resume-run`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
