...
description: "Execute the Agentic Spec 00 intake workflow for normalize input with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `00` `intake` workflow step for `normalize-input`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
