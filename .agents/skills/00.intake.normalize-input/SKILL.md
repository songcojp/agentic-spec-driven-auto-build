---
name: 00.intake.normalize-input
description: "Run the Agentic Spec intake normalize input workflow. Use when the scheduler, operator, or another skill explicitly requests `00.intake.normalize-input` and needs traceable normalized intake facts, constraints, or open questions inside the project-intake and source-normalization boundary."
---
...
1. Confirm the invocation requested `00.intake.normalize-input`, identify the target artifact or object, and verify the current state allows this normalize input step.
