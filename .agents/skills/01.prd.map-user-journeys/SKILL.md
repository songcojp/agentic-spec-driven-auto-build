...
description: "Execute the Agentic Spec 01 prd workflow for map user journeys with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `01` `prd` workflow step for `map-user-journeys`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
