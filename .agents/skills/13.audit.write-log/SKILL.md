---
name: 13.audit.write-log
description: "Run the Agentic Spec audit write log workflow. Use when the scheduler, operator, or another skill explicitly requests `13.audit.write-log` and needs traceable evidence, logs, matrices, and audit traceability updates inside the audit and evidence boundary."
---
...
1. Confirm the invocation requested `13.audit.write-log`, identify the target artifact or object, and verify the current state allows this write log step.
