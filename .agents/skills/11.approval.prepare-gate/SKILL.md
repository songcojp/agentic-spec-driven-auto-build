...
description: "Execute the Agentic Spec 11 approval workflow for prepare gate with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `11` `approval` workflow step for `prepare-gate`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
