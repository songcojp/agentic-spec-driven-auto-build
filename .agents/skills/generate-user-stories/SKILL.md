...
- Return `review_needed` or `clarification_needed` when Must-scope stories are too shallow or rows cannot be made atomic, testable, or traceable from the available source artifacts.
