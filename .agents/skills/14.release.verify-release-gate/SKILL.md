...
description: "Execute the Agentic Spec 14 release workflow for verify release gate with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `14` `release` workflow step for `verify-release-gate`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
