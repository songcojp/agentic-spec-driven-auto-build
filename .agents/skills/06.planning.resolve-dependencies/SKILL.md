...
description: "Execute the Agentic Spec 06 planning workflow for resolve dependencies with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `06` `planning` workflow step for `resolve-dependencies`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
