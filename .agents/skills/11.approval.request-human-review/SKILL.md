...
description: "Execute the Agentic Spec 11 approval workflow for request human review with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `11` `approval` workflow step for `request-human-review`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
