...
description: "Execute the Agentic Spec 07 execution workflow for bind spec refs with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `07` `execution` workflow step for `bind-spec-refs`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
