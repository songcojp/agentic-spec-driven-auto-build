...
description: "Execute the Agentic Spec 07 execution workflow for collect result with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `07` `execution` workflow step for `collect-result`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
