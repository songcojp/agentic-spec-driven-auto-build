...
Classify the request by lifecycle span; preserve source intent, behavior obligations, evidence needs, and handoff risks. Select the smallest set of project skills and reviewer roles needed to complete the work.
