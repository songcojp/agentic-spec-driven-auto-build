---
name: 04.ui.define-states
description: "Run the Agentic Spec UI define states workflow. Use when the scheduler, operator, or another skill explicitly requests `04.ui.define-states` and needs traceable UI states, interactions, page lists, or UI specification artifacts inside the UI specification and interaction boundary."
---
...
1. Confirm the invocation requested `04.ui.define-states`, identify the target artifact or object, and verify the current state allows this define states step.
