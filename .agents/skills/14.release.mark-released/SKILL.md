---
name: 14.release.mark-released
description: "Run the Agentic Spec release mark released workflow. Use when the scheduler, operator, or another skill explicitly requests `14.release.mark-released` and needs traceable release-gate, PR-prep, release note, archive, or released-state outputs inside the release and delivery boundary."
---
...
1. Confirm the invocation requested `14.release.mark-released`, identify the target artifact or object, and verify the current state allows this mark released step.
