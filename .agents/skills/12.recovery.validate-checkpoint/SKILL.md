...
description: "Execute the Agentic Spec 12 recovery workflow for validate checkpoint with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `12` `recovery` workflow step for `validate-checkpoint`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
