...
description: "Review code and specs. Use for code diff review, spec consistency checks, architecture risk review, security review, and identifying implementation drift from requirements or Feature Specs."
---
...
Lead with blocking findings and cite files, specs, tests, or evidence. Separate bugs, spec drift, missing tests, and advisory improvements.
