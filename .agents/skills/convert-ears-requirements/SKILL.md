---
name: convert-ears-requirements
description: "Convert PRDs, product briefs, PR/RP text, or natural-language requirements into atomic EARS requirements. Use when product prose must become testable user stories, REQ, NFR, EDGE entries, acceptance criteria, traceability, and open questions."
---

# EARS Requirement Conversion
...
Generate stable user stories and atomic EARS requirements. Preserve source traceability, surface ambiguity, and keep Feature Spec splitting out of this skill.
