...
description: "Execute the Agentic Spec 11 approval workflow for reject and replan with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `11` `approval` workflow step for `reject-and-replan`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
