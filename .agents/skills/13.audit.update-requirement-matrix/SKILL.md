...
description: "Execute the Agentic Spec 13 audit workflow for update requirement matrix with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `13` `audit` workflow step for `update-requirement-matrix`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
