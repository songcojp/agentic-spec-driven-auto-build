...
description: "Execute the Agentic Spec 05 feature workflow for validate scope with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `05` `feature` workflow step for `validate-scope`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
