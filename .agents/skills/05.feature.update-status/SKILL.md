...
description: "Execute the Agentic Spec 05 feature workflow for update status with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `05` `feature` workflow step for `update-status`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
