...
description: "Execute the Agentic Spec 00 intake workflow for identify constraints with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `00` `intake` workflow step for `identify-constraints`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
