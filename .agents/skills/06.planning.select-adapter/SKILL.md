...
1. Confirm the invocation requested `06.planning.select-adapter`, identify the target artifact or object, and verify the current state allows this select adapter step.
