...
description: "Execute the Agentic Spec 14 release workflow for archive run with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `14` `release` workflow step for `archive-run`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
