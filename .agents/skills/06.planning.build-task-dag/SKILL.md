...
description: "Execute the Agentic Spec 06 planning workflow for build task dag with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `06` `planning` workflow step for `build-task-dag`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
