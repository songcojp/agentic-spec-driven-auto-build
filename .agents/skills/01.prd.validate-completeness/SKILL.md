...
description: "Execute the Agentic Spec 01 prd workflow for validate completeness with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `01` `prd` workflow step for `validate-completeness`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
