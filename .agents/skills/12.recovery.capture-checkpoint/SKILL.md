...
description: "Execute the Agentic Spec 12 recovery workflow for capture checkpoint with reusable input references, output contract, and acceptance checks."
---
...
Use this skill to perform the Agentic Spec `12` `recovery` workflow step for `capture-checkpoint`. Keep the workflow reusable across Agentic Spec projects and avoid product-specific assumptions.
